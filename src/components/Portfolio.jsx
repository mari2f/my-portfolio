...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      description:
        "Custom SAP Fiori launchpad with role-based tiles and responsive design",
      technologies: ["SAP Fiori", "UI5", "OData", "ABAP"],
    },
    {
      id: 2,
      title: "SAP Fiori Freestyle App",
      category: "sap",
      image:
        "https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&cs=tinysrgb&w=800",
      description:
        "Freestyle SAP application for financial reporting, List Report, Fact sheet and data visualization",
      technologies: ["Fiori", "UI5", "Freestyle", "SAP BTP Fiori"],
    },
    {
      id: 3,
      ...
      description:
        "Mobile application for employee data management and reporting",
    ...
    },
    {
      ...
      description:
        "Middleware solution for SAP system integrations and data exchange",
      technologies: ["SAP PI/PO", "REST", "SOAP", "JSON"],
    },
    {
      id: 5,
      title: "Student Analytics Dashboard using SAP Build Code",
      category: "analytics",
      image:
        "https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=800",
      description:
        "Analytics dashboard for student performance tracking and reporting",
      technologies: ["SAP Build code", "Joule", "CAPM", "Node.js"],
    },
    {
      id: 6,
      ...
      description:
        "Automated employee leave request process using SAP Workflow, enabling seamless approval flows and efficient business process management.",
      technologies: [
        "SAP Workflow",
        "Business Rules",
        "Forms",
  ...
  const filters = [
    ...
    { id: "analytics", label: "SAP Build Code", icon: <Database size={16} /> },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Explore my SAP development projects showcasing enterprise solutions
